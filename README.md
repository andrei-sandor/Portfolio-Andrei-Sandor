...
Created alone a website showcasing main highlights of my professional and personal career. This website is composed of main tabs redirecting to diffrent links. The first tab is the main tab. This tab contains a picture of me and a quick introduction about myself. Then, the next tab is about the schools that I have went. Furthermore, there is an experience tab where I showcase my professional internship experience so far. Then, the next tab is an elegant high-level view of the main projects that I have worked so far on. The next tab is about tutoring oportunities that I offer. This tab is a form that further tutee complete where I collect all the relevent information so that I can help them. Finally, the last tab is about importnat links related to me.

To create this website that runs locally on machine in localhost:5174, I used all my frontend experience from my three years of high-school programming. I applied all my HTML knowledge by basing around div and advanced objects in HTML. Then, to make everything look good, I applied the CSS by touching a variety of features that I know to customize in a simple and efficient way everything that I know to produce an elegent view without Boostrap. Finaly, for the tutoring form, I included some JavaScript to make it more interesting. Also, I used all my school experience related to frontend from courses like ECSE 321 (Intro to Software Engineering) and ECSE 428 (Software Engineering Practice). I applied the Vue.js to create a nice header for each file. I was working around commponents, views and router. I included all my HTML, CSS and JS into view files. I also organized the to how it is by creating the tabs and the overall structure.
